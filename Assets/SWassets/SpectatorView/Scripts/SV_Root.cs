...
public class SV_Root : SV_Singleton<SV_Root>
{
    ...
    {
        var model = Instantiate(obj); // instaniate model in scene and savel link to it
    ...
    {
        var model = Instantiate(obj, position, rotation); // instaniate model in scene and savel link to it
